...
const Scanner = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setErrorDialogMessage("Failed to load user data.");
        setErrorDialogOpen(true);
      }
    };
  ...
  const handleScan = (data) => {
    if (data) {
      try {
        ...
        if (!userDetails) {
          setErrorDialogMessage("User details not loaded yet. Please try again.");
          setErrorDialogOpen(true);
          return;
        }
        ...
        setErrorDialogMessage("Invalid QR code format.");
        setErrorDialogOpen(true);
      }
    }
  };
  ...
  const handleError = (err) => {
    ...
    setErrorDialogMessage("QR Scanner encountered an error.");
    setErrorDialogOpen(true);
  };
