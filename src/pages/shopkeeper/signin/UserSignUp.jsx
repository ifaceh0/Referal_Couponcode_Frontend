...
import PhoneInput from 'react-phone-input-2';
import 'react-phone-input-2/lib/style.css';
// import { signupUser } from "../../../api/signin"; // Uncomment and correct the import
...
const UserSignUp = () => {
  ...
  const handlePopupSubmit = async () => {
    ...
    try {
      const { confirmPassword, ...submitData } = formData;
      submitData.referralCode = referralCode; // Optional field
      const responseMessage = await signupUser(submitData); // Ensure this function exists
