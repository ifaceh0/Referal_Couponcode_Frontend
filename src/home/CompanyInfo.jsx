...
import { Link } from "react-router-dom";
import { CheckCircle2, BarChart3, Zap, Ticket, UserPlus, Users, Gift, DollarSign, Link as LinkIcon } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative bg-gradient-to-br from-gray-900 to-blue-900 rounded-xl p-8 shadow-2xl overflow-hidden group">
              ...
              <div className="space-y-5 opacity-85 group-hover:opacity-100 transition-opacity">
                ...
                <div className="flex justify-between items-center">
                  <div className="text-white text-sm font-medium">PromoConnect Dashboard</div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="bg-white/10 rounded-xl p-3 text-center border border-white/10">
                    <div className="text-green-400 font-bold text-xl">4,250</div>
                    <div className="text-[10px] uppercase text-gray-400 mt-1">
                      Referrals Generated
                    </div>
                  </div>
                  <div className="bg-white/10 rounded-xl p-3 text-center border border-white/10">
                    <div className="text-blue-400 font-bold text-xl">12.8k</div>
                    <div className="text-[10px] uppercase text-gray-400 mt-1">
                      Coupons Redeemed
                    </div>
                  </div>
                  <div className="bg-white/10 rounded-xl p-3 text-center border border-white/10">
                    <div className="text-purple-400 font-bold text-xl">38%</div>
                    <div className="text-[10px] uppercase text-gray-400 mt-1">
                      Repeat Customers
                    </div>
                  </div>
                ...
                <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                  <div className="flex justify-between mb-3">
                    <div className="text-xs text-gray-300">Recent Campaign Activity</div>
          ...
          <div>
            ...
            <p className="mt-6 text-md text-gray-700 leading-relaxed">
              PromoConnect helps businesses acquire new customers through referral marketing and increase repeat purchases using digital coupon campaigns.
            </p>
              ...
              {[
                {
                  ...
                  text: "Referral Program Management",
                  sub: "Reward customers and track referral conversions."
                },
                {
                  icon: <Ticket size={22} />,
                  text: "Coupon Campaign Builder",
                  sub: "Create discount offers and monitor redemptions."
                },
                {
                  icon: <LinkIcon size={22} />,
                  text: "QR Code Promotions",
                  sub: "Share campaigns instantly through QR codes."
                },
                {
                  icon: <BarChart3 size={22} />,
                  text: "Real-Time Analytics",
                  sub: "Measure campaign performance and ROI."
                }
              ].map((item, i) => (
